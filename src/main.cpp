...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (ortho_per){
           ...
           my_scene.Ortho3D(-20.0,20.0,-20.0,20.0,0.0,200.0);
        }
        
        braco.setShoulderAngleDegrees(ombrox, ombroy, ombroz);
        braco.setElbowAngleDegrees(cotoveloz);
        braco.setHandAngleDegrees(maox);
        braco.setFingerAngleDegrees(dedoz);
